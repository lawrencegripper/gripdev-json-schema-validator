@{
    # Module manifest for module 'NewtonsoftJsonSchemaTool'
    # Generated by: YourName
    # Generated on: 2023-04-01

    # Script module or binary module file associated with this manifest.
    RootModule = 'NewtonsoftJsonSchemaTool.psm1'
    ...
    FileList = @('NewtonsoftJsonSchemaTool.psm1', 'Newtonsoft.Json.dll', 'Newtonsoft.Json.Schema.dll')
